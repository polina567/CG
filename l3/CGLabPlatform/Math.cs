...
namespace CGLabPlatform
{
	...
	public struct DVector2 : ICloneable, IEquatable<DVector2>, IFormattable
	{
		...
		/// <returns></returns>
		public static DVector2 Rotate(DVector2 vector, double angle)
        {
			return new DVector2(vector.X * Math.Cos(angle) - vector.Y * Math.Sin(angle),
		...
		public DVector2 Rotate(double angle)
        {
			...
			return new DVector2(this.X * Math.Cos(angle) - this.Y * Math.Sin(angle),
